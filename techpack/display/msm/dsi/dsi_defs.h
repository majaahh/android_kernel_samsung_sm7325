 ...
 * @null_insertion_enabled:  Is automatic null packet insertion enabled.
 * @null_insertion_wc:	 Word count (number of bytes) of the inserted null
 *			 packet payload.
 */
